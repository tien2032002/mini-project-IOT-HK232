...
AIO_KEY = "aio_LkkP17rHpMPmWLNSRdZ3qGtXeUml"
...
class MQTT:
    def __init__(self) -> None:
        ...
        # button
        self.led_button = self.getCurrentTopicData(LED_BUTTON)
        self.ac_button = self.getCurrentTopicData(AC_BUTTON)
        
        # time
        self.user_datetime = json.loads(self.getCurrentTopicData("user-datetime"))
    ...
    def message(self, client , feed_id , payload):
        ...
        elif (feed_id == "user-datetime"):
            print(payload)
            print(type(payload))
            self.user_datetime = json.loads(payload)
